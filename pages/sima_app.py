        ...
        def convertir_a_sima(archivo_excel,estacion, campana_filtro):
            if estacion == "Verano":
                ...
                def exportar_sima_verano(verano):
                    ...
                    ruta_original = 'https://raw.githubusercontent.com/epolacco/integracion_dat/raw/main/data/DAT-Cultivos-de-verano-2023-24-1.xlsx'
                    ...
                    for i, seccion_df in enumerate(dataframes, 1):
                        ...
                        if i == 1:
                            ...
                            ruta_copia = f'{cuic}_DAT-Cultivos-de-verano-2023-24-1_SECCION_{i}.xlsx'
                        ...
                        if i != 1:
                            wb.save(ruta_copia)
                            rutas_archivos.append(ruta_copia)
                    
                    # Guardar workbook con el primer df
                    ruta_alternativa = f'{cuic}_DAT-Cultivos-de-verano-2023-24-1_SECCION_1.xlsx'
                    wb_original.save(ruta_alternativa)
                    rutas_archivos.append(ruta_alternativa)
                    
                    return rutas_archivos
                # Proceso de archivo y descarga
                if 'df' in locals() and 'cuic' in locals() and 'region' in locals() and 'grupo' in locals():
                    rutas_archivos = exportar_sima_verano(verano)
                ...
                def exportar_sima_invierno(invierno):
                    ...
                    # Ruta del archivo original
                    ruta_original = 'https://raw.githubusercontent.com/epolacco/integracion_dat/raw/main/data/DAT-Cultivos-de-invierno-2023-24.xlsx'
                    ...
                    for i, seccion_df in enumerate(dataframes, 1):
                        ...
                        if i == 1:
                            ...
                            # Crear una copia del archivo original para los df subsiguientes
                            ruta_copia = f'{cuic}_DAT-Cultivos-de-invierno-2023-24-_SECCION_{i}.xlsx'
                            shutil.copy(ruta_original, ruta_copia)
                    ...
                    # Guardar workbook con el primer df
                    ruta_alternativa = f'{cuic}_DAT-Cultivos-de-invierno-2023-24-1_SECCION_1.xlsx'
                    wb_original.save(ruta_alternativa)
                    rutas_archivos.append(ruta_alternativa)
                ...
                # Proceso de archivo y descarga
                if 'df' in locals() and 'cuic' in locals() and 'region' in locals() and 'grupo' in locals():
                    rutas_archivos = exportar_sima_invierno(invierno)
                    # Mostrar enlaces de descarga para cada archivo
                    for ruta in rutas_archivos:
                        with open(ruta, "rb") as file:
                            btn = st.download_button(
